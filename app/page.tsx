            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  ...
                  <div className="ml-4 mt-1 text-gray-700">This hasn&apos;t been merged yet. I&apos;m not sure if I make changes in line with the maintainers&apos; intentions, but... there was a TODO comment in the codebase for 2 months about cleaning up redirect handling. I refactored it to use direct dispatch methods instead of the public API instance. There&apos;s some other work that could be done in that file as well, but I want to see how their test runner works before I go further. Well, I already have, but I want to verify my theoretical changes won&apos;t break anything..</div>
                </li>
                <li>
