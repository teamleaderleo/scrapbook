              ...
              <tbody className="bg-white">
                {[...Array(6)].map((_, index) => (
                  <tr key={index} className="w-full border-b py-3 text-sm last-of-type:border-none">
                    <td className="whitespace-nowrap py-3 pl-6 pr-3">
                      <div className="flex items-center">
                        <div className="h-10 w-10 flex-shrink-0 rounded-full bg-transparent"></div>
                        <div className="ml-4 h-4 w-20 rounded bg-transparent"></div>
                      </div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-3">
                      <div className="h-4 w-16 rounded bg-transparent"></div>
                    </td>
                    <td className="px-3 py-3">
                      <div className="h-4 w-32 rounded bg-transparent"></div>
                    </td>
                    <td className="px-3 py-3">
                      <div className="h-4 w-24 rounded bg-transparent"></div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-3">
                      <div className="h-4 w-8 rounded bg-transparent"></div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-3">
                      <div className="h-4 w-24 rounded bg-transparent"></div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-3">
                      <div className="flex space-x-2">
                        {[...Array(3)].map((_, i) => (
                          <div key={i} className="h-10 w-10 rounded-full bg-transparent"></div>
                        ))}
                      </div>
                    </td>
                    <td className="whitespace-nowrap py-3 pl-6 pr-3">
                      <div className="flex justify-end space-x-2">
                        <div className="h-8 w-8 rounded bg-transparent"></div>
                        <div className="h-8 w-8 rounded bg-transparent"></div>
                      </div>
                    </td>
                  </tr>
