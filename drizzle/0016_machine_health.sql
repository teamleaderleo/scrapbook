...
CREATE TABLE IF NOT EXISTS "machine_health_samples" (
  ...
  "disk_read_mib_s" double precision,
  "disk_write_mib_s" double precision,
  "pressure_percent" double precision,
  "activity_source" text NOT NULL,
  "activity_sample_count" integer NOT NULL,
  "activity_window_minutes" integer NOT NULL,
