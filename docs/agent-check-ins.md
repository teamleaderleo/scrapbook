...
Those archived files are the complete former guides. They describe a deprecated manual path and are not the default instruction set for agents or automation.
